...
// `keyboard_response` is the name of the table we've created for this experiment.
...
* 
* q = 'mysql_query("INSERT INTO keyboard_response ('
...
* 
*/
mysql_query("INSERT INTO keyboard_response (paradigm, experiment_start_time, subject_nr, trial_number, stimuli_number, probe, code, response, rt)
